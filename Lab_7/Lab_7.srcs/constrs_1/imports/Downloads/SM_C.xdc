...
set_property PACKAGE_PIN E3 [get_ports CLK]							
	...
	set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets PBC_IBUF]
	create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports CLK]
 
## Switches
#Bank = 34, Pin name = IO_L21P_T3_DQS_34,					Sch name = SW0
set_property PACKAGE_PIN J15 [get_ports {X1}]
	set_property IOSTANDARD LVCMOS33 [get_ports {X1}]
#Bank = 34, Pin name = IO_25_34,						Sch name = SW1
set_property PACKAGE_PIN L16 [get_ports {X2}]	
	set_property IOSTANDARD LVCMOS33 [get_ports {X2}]
#Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN M13 [get_ports {X3}]					
...
set_property PACKAGE_PIN V10 [get_ports {CLK_Speed}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {CLK_Speed}]
 

## LEDs
#Bank = 34, Pin name = IO_L24N_T3_34,						Sch name = LED0
set_property PACKAGE_PIN H17 [get_ports {Z1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Z1}]
#Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN K15 [get_ports {Z2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Z2}]
#Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
set_property PACKAGE_PIN J13 [get_ports {Z3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Z3}]
#Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
set_property PACKAGE_PIN N14 [get_ports {q0}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {q0}]
#Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
set_property PACKAGE_PIN R18 [get_ports {q1}]					
