...
HD_PWD='/media/sf_gits/DSD/Lab_3/Lab_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_8bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_8bit.tcl -notrace
