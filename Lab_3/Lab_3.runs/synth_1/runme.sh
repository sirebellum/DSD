...
HD_PWD='/media/sf_gits/DSD/Lab_3/Lab_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_8bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_8bit.tcl
