...
HD_PWD='/media/sf_gits/DSD/HW_4/HW_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sync_4Counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sync_4Counter.tcl
