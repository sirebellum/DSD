...
HD_PWD='/media/sf_gits/DSD/HW_2/HW_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux1_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux1_4.tcl
