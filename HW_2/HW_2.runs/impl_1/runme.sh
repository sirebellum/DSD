...
HD_PWD='/media/sf_gits/DSD/HW_2/HW_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux1_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux1_4.tcl -notrace
