...
set rc [catch {
  ...
  set_property webtalk.parent_dir /media/sf_gits/DSD/Lab_2/Lab_2.cache/wt [current_project]
  set_property parent.project_path /media/sf_gits/DSD/Lab_2/Lab_2.xpr [current_project]
  set_property ip_output_repo /media/sf_gits/DSD/Lab_2/Lab_2.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet /media/sf_gits/DSD/Lab_2/Lab_2.runs/synth_1/Mux4.dcp
  read_xdc /media/sf_gits/DSD/Lab_2/Lab_2.srcs/constrs_1/imports/sf_Downloads/Mux4RevC.xdc
  link_design -top Mux4 -part xc7a100tcsg324-1
...
set rc [catch {
  ...
  catch { write_mem_info -force Mux4.mmi }
  write_bitstream -force Mux4.bit 
  catch {write_debug_probes -no_partial_ltxfile -quiet -force debug_nets}
  catch {file copy -force debug_nets.ltx Mux4.ltx}
